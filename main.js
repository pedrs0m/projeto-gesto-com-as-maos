...
classifier = ml5.imageClassifier('https://storage.googleapis.com/tm-model/clewhAe36/model.json',modelLoaded);
...
function gotResult(error, results) {
  if (error) {
    ...
    if(results[0].label == "Mão da Vitoria")
    {
    ...
    if(results[1].label == "Mão da Vitoria")
    {
